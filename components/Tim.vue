<template>
  <div class="bg-gray-900 mt-20">
            ...
            <div class="space-y-6 xl:space-y-10">
              ...
              <div class="space-y-2 xl:flex xl:items-center xl:justify-between">
                <div class="font-medium text-lg leading-6 space-y-1 text-center w-full">
                  ...
                  <p class="text-fizio-500">{{ person.role }}</p>
                </div>
              </div>
            </div>
          </li>
    ...
    <a href="/cjenik" class="inline-block px-8 mb-12 bg-gradient-to-r from-orange-500 to-rose-500 border border-transparent rounded-md shadow py-4 text-xl uppercase font-medium text-white text-center transition duration-400 hover:to-rose-600 ">Saznaj više o terapeutima</a>
