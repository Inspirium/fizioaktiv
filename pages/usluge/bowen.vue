<template>
  <div class="">
    <Heroservices>
      <slot>
        <span class="px-5 py-2 text-white text-base font-semibold leading-5 uppercase tracking-wide bg-fizio-500 rounded-full">Liječenje dodirom</span>
    ...
    <main>
      <div class="lg:col-start-4grid sm:grid-cols-[2rem_auto_250px_800px_250px_auto_2rem] mx-auto text-left text-gray-600 font-open space-y-5 px-8">
        <p class="lg:col-start-4 text-2xl mb-8 leading-10 font-semibold font-poppins">Bowen terapija je manualna terapijska metoda koja se koristi specijaliziranim pokretima na mekom tkivu u rješavanju biomehaničkih poremećaja.
        </p>
        ...
        <h2 class="lg:col-start-4 pt-4">Indikacije za Bowen terapiju</h2>
