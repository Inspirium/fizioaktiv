  ...
  <div class="">
    <Heroservices>
      <slot>
        ...
        <h1 class="mt-4 text-4xl tracking-tight font-extrabold sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
          <span class="block text-gray-600 font-barlow uppercase font-light sm:text-8xl">EMMETT terapija</span>
        </h1>
    ...
    <main>
      <div class="grid sm:grid-cols-[2rem_auto_250px_800px_250px_auto_2rem] mx-auto text-left text-gray-600 font-open space-y-5">
        <p class="sm:col-start-4 text-2xl mb-8 leading-10 font-semibold font-poppins">EMMETT tehnika je jedinstveni oblik tjelesne terapije a podrazumijeva primjenu laganog pritiska prstima na određene točke tijela (tzv. EMMETT točke) koje su ime dobile po autoru tehnike, Rossu Emmettu.
        </p>
        <p class="sm:col-start-4 text-lg">Vrlo je brza metoda koja pri aktivaciji pravog mišića daje učinkovite rezultate čim se korekcija mišića ( pritisak na mišić ) provede. Mjesta na kojima se radi pritisak (tzv. Emmett točke) su mjesta preklapanja senzornih ili receptornih  i mišićnih točaka. Učinak korekcije mišića može se neposredno testirati mjerenjem snage, gibljivosti ili balansa. Mišić bude facilitiran ili relaksiran, ovisno o odgovoru propadajućih proprioceptora.
        </p>
        ...
        <p class="sm:col-start-4 text-lg">Može se koristiti kod odraslih osoba, a također i kod beba i male djece, tj. nema dobnih ograničenja.
        </p>

        <h2 class="sm:col-start-4 pt-4">Najčešće indikacije za primjenu EMMETT tehnike su:
        </h2>
